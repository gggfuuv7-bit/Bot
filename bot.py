...
CF_MODEL = "@cf/anthropic/claude-opus-4.8" # Cloudflare-এর Claude Opus 4.8 যুক্ত করা হলো
...
def handle_all_messages(message):
    ...
    bot.send_message(chat_id, "Processing your request with Claude Opus 4.8... Please wait.")
    ...
    try:
        ...
        system_instruction = (
            "You are Claude Opus, an expert AI coding assistant. "
                    ...
                    if line:
                        ...
                        if decoded_line.startswith("data: "):
                            ...
                            try:
                                ...
                                # Cloudflare-এর Claude মডেলের জন্য কমপ্যাটিবল পার্সিং
                                if "response" in chunk:
                                    ...
                                    if "content" in delta:
                                        ...
                                        final_response_text += delta["text"]
                            except:
                                pass
            else:
...
@app.route('/')
def home():
    return "Bot is securely running 24/7 with Claude Opus 4.8!"
