...
# স্ক্রিনশট অনুযায়ী সঠিক মডেল আইডি (কোনো @cf/ প্রিফিক্স ছাড়া)
...
# --- টেলিগ্রাম Empty Message Error ফিক্স ---
def safe_send_message(chat_id, text, **kwargs):
    if not text or not str(text).strip():
        text = "⚠️ [Empty response generated by API]"
...
def clear_memory(message):
    ...
    safe_send_message(chat_id, "🧹 বটের মেমোরি ক্লিয়ার করা হয়েছে! নতুন প্রজেক্ট শুরু করতে পারেন।")
...
def handle_all_messages(message):
    ...
    safe_send_message(chat_id, "Processing your request with Claude Opus 4.8... Please wait.")
    ...
    try:
        ...
        try:
            ...
            if response.status_code == 200:
                ...
                safe_send_message(chat_id, f"API Error: {response.status_code}\n{response.text}")
        ...
        if not final_response_text.strip():
            safe_send_message(chat_id, "❌ কোনো ডেটা জেনারেট হয়নি। আবার চেষ্টা করুন।")
            user_chat_history[chat_id].pop()
            return
        ...
        safe_send_message(chat_id, f"An error occurred: {str(e)}")
