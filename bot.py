...
# টোকেন মিসিং থাকলে লগে ক্লিয়ার মেসেজ দেওয়ার সিকিউরিটি চেক
if not BOT_TOKEN:
    print("❌ ERROR: BOT_TOKEN is missing! Please add it to Render Environment Variables.")
    sys.exit(1)

ALLOWED_USER_ID = 5062314716 

# --- Kie.ai API কনফিগারেশন ---
KIE_API_TOKEN = "705642c427c89e3ec6cae822307facde" 
